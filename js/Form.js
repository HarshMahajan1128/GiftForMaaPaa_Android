class Form {
  constructor() {
    ...
    this.confession = createElement('h3');
  ...
  display(){
    ...
    this.input.position(displayWidth/2 - 135, displayHeight - 500);
    this.button.position(displayWidth/2 + 53, displayHeight - 500);
    this.button2.hide();
    this.button2.position(displayWidth - 50, displayHeight - 200);
    ...
    this.button.mousePressed(()=>{
      ...
      if(this.input.value() === "Vivek" || this.input.value() === "Shweta" && this.button.mousePressed){
        ...
        bg.height = displayHeight + 1000;
        bg.width = displayWidth + 1000;
        this.button2.show();
        ...
        if(positionFlag===1){
          // console.log("in pos")
           video.position(width/2 - displayWidth, height/2 - displayHeight);
